...
echo $PATH
export PATH="/run/user/1001/fnm_multishells/449478_1771356157082/bin:$PATH"
echo $PATH
...
* How does caribou movement (e.g., velocity, directionality) change as a result of road interactions? 
